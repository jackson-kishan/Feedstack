            ...
            <main>
                <div className="grid min-h-screen w-full overflow-hidden lg:grid-cols-[280px_1fr]">
                    <div className="hidden border-r lg:block">
                        <div className="flex flex-col gap-2">
                            <div className="flex-1 py-4">
                                <nav className="grid items-start px-4 text-sm font-medium ">
                                    ...
                                    <SideNavLink
                                        href={route("members", { board })}
                                        active={route().current("members")}
                                    >
                                        Members
                                    </SideNavLink>
                                    <SideNavLink
                                        href={route("notification.index", {board})}
                                        active={route().current("notification.index")}
                                    >
                                        Notification
                                    </SideNavLink>
                                    <SideNavLink
                                        href={route("annoucement.index", {
                                            board,
                                        })}
                                        active={route().current(
                                            "annoucement.index"
                        ...
                        {/* <div className="bottom-2 fixed p-2 bg-gray-400 w-[280px]"> */}

                        <NavLink
                            href={route("general.index", { board })}
                            active={route().current("general.index")}
                            className="flex items-center justify-center text-center font-semibold ml-3 w-[250px] bottom-2 fixed p-2 bg-gray-400 "
                        >
                            Settings
                        </NavLink>
                    </div>
